...
Tree = function() {
	...
	treeMidMesh.position.set(0*size,-4*size,0*size);
	...
	treeBottomMesh.position.set(0*size,-9*size,0*size);
	...
	treeTrunkMesh.position.set(0*size,-17*size,0*size);
